...
public class MyApplicationModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        Configuration conf = Configuration.getDefaults()
          .add(RESOURCE_PATH, "in.shopquare.demo1")
          .add(VIEW_COMPONENT_ROOT_PACKAGE, "in.shopquare.demo1.web.views")
          .add(RELOADABLE_CLASSES.includedPackage("in.shopquare.demo1.web.components"))
